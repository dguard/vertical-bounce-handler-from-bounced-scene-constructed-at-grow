...
let radius = Math.random() * 12 * 10 * 0.4
// let radius = getRandomInt(8, 8) * 10 * 0.4
let spawnedPointerBelongings = draftFabrikk.spawnPointerBelongingsAtRectangle(/* keep */ /* y, x, z */ Math.random() * width * 0.5 * 0.5, Math.random() * width * 0.5 * 0.5, debPointer, /* radius, d, f, frontRatio */ radius, 0.9, 0.4, 1, /* keep */ /* debthScaleRatio, frontScaleRatio, profileScaleRatio */ 1, 1, 1)
...
// keep
let knot1 = draftFabrikk.constructKnot(/* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ (1 * 4 * 2) * 5, 1, 1 * 4 * 2 * 1.4)
...
let spawnedPointerBelongingsAnother = draftFabrikk.spawnPointerBelongingsAtRectangle(/* keep */ /* y, x, z */ spawnedPointerBelongings.y, spawnedPointerBelongings.x, debPointer, /* radius, d, f, frontRatio */ radius, 0.9, 0.4, 1, /* keep */ /* debthScaleRatio, frontScaleRatio, profileScaleRatio */ (1 * 4 * 2) * 5 /* + 0.4 */, 1, 1 * 2)
let knot2 = draftFabrikk.constructKnot(/* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ (1 * 0.5 * 0.5) * 5, 1, 4 * 1 * 2 * 1.4)
...
let knot3 = draftFabrikk.constructKnot(/* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ (1 * 3.5 * 2) * 5 + 3.2, 1, 1 * 0.5)
...
let spawnedPointerBelongingsRest = draftFabrikk.spawnPointerBelongingsAtRectangle(/* keep */ /* y, x, z */ spawnedPointerBelongings.y, spawnedPointerBelongings.x, debPointer, /* radius, d, f, frontRatio */ radius, 0.9, 0.4, 1, /* keep */ /* debthScaleRatio, frontScaleRatio, profileScaleRatio */ 1, (1 * 4 * 2) * 1.4 + 0.5, 1 * 2)
let knot4 = draftFabrikk.constructKnot(/* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ (1 * 3.5 * 2) * 5 + 3.2, 1, 1 * 0.5)
...
let knotClosing = draftFabrikk.constructKnot(/* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ (1 * 4 * 2) * 5, 1 * 0.5, 4 * 1 * 2 * 1.4)
